          ...
          {alerts.map((alert) => (
            <div className="alert-card-pro" key={alert.id}>
              <div className="alert-card-top">
                <span className="alert-badge">{alert.alert_type || "EMERGENCY"}</span>
              ...
              <h3 className="alert-title">{alert.message || "Emergency Alert"}</h3>

              <div className="alert-info-grid">
                <div className="info-box">
                  <span className="info-label">Heart Rate</span>
                  <span className="info-value">{alert.heart_rate ?? "--"} bpm</span>
                </div>

                <div className="info-box">
                  <span className="info-label">SpO₂</span>
                  <span className="info-value">{alert.spo2 ?? "--"} %</span>
                </div>
              </div>
